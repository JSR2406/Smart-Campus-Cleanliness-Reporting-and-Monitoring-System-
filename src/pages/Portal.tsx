...
export default function Portal() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 selection:bg-primary/20 grid-bg transition-colors duration-300">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto px-6 py-24 md:py-40 relative z-10">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl font-display font-bold text-ink tracking-tighter mb-10 leading-[0.85]">
      ...
      <div className="max-w-7xl mx-auto px-6 pb-24">
        <motion.div 
          ...
          viewport={{ once: true }}
          className="bg-card-bg rounded-[3rem] p-12 md:p-20 shadow-2xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800 flex flex-col md:flex-row items-center gap-12 transition-colors duration-300"
        >
